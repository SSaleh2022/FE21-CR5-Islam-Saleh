...
class location1 {
	...
	constructor(name:string, image: string, ZIP_code: number, address: string, city: string, date: Date) {
	this.name = name;
    this.image = image;
    this.city = city;
...
class restaurants extends location1{
    ...
    dishes: string;
    URL: any;
    constructor(name:string, image: string, ZIP_code: number, address: string, city: string, date: Date, tel: any, dishes: string, URL: any) {
...
TicketPrice: any;
constructor(name:string,image: string, ZIP_code: number, address: string, city: string, date: Date, TicketPrice: any) {
super(name,image, ZIP_code, address, city, date);
...
(document.querySelector(".sortdown") as HTMLElement).addEventListener("click", datesort)
function datesort () {
...
(document.querySelector(".sortup") as HTMLElement).addEventListener("click", datesort1)
function datesort1 () {
    all.sort(function(a, b) {
