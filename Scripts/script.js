...
let all = [];
class location1 {
    constructor(name, image, ZIP_code, address, city, DateTime) {
        this.name = name;
        this.image = image;
        this.city = city;
...
class restaurants extends location1 {
    constructor(name, image, ZIP_code, address, city, DateTime, tel, dishes, URL) {
...
class Events extends location1 {
    constructor(name, image, ZIP_code, address, city, DateTime, TicketPrice) {
        super(name, image, ZIP_code, address, city, DateTime);
...
document.querySelector(".sortdown").addEventListener("click", DateTimesort);
...
;
document.querySelector(".sortup").addEventListener("click", DateTimesort1);
